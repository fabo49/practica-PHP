		...
		<div class="container">
			<div class="row">
				<div class="col s12">
					...
					<p class="flow-text">Este formulario le permite guardar direcciones de contactos en el sistema.</p>
				</div>
			</div>
			<div class="row">
				<form name="visita" id="visita" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="col s12 ">
					...
					<div class="input-field col s6">
						<input type="text" class="validate" name="nombre" id="nombre" maxlength="50">
						<label for="nombre">Nombre</label>
					</div>
					<div class="input-field col s6">
						<input type="text" class="validate" name="apellidos" id="apellidos" maxlength="50">
						<label for="apellidos">Apellidos</label>
					</div>
					<div class="input-field col s12">
						<input type="tel" class="validate" name="tel_casa" id="tel_casa" maxlength="15">
						<label for="tel_casa">Teléfono de la casa</label>
					</div>
					<div class="input-field col s12">
						<textarea type="text" cols="50" rows="2" class="materialize-textarea validate" name="direccion_casa" id="direccion_casa" length="256"></textarea>
						<label for="direccion_casa">Dirección de la casa</label>
					</div>
					<div class="input-field col s12">
						<input type="tel" class="validate" name="tel_trabajo" id="tel_trabajo" maxlength="15">
						<label for="tel_trabajo">Teléfono del trabajo</label>
					</div>
					<div class="input-field col s12">
						<textarea type="text" cols="50" rows="2" class="materialize-textarea validate" name="direccion_trabajo" id="direccion_trabajo" length="256"></textarea>
						<label for="direccion_trabajo">Dirección del trabajo</label>
					</div>
					<div class="input-field col s12">
						<input name="correo" type="email" id="correo" class="validate">
